        ...
        <div>
          <div className={style.designtext_container}>
            <button
              ...
              style={{
                backgroundColor: category == categoryNames.design ? "#181818" : "#fff",
                color: category == categoryNames.design ? "#fff" : "#000",
              }}
              onMouseEnter={() => {
            ...
            <button
              className={style.boxtext_technology}
              onClick={() => {
                getCategory(categoryNames.tech);
              }}
              style={{
                backgroundColor: category == categoryNames.tech ? "#181818" : "#fff",
                color: category == categoryNames.tech ? "#fff" : "#000",
              }}
              onMouseEnter={() => {
                changeCursor("size_defference");
              }}
            ...
            <button
              className={style.boxtext_business}
              onClick={() => {
                getCategory(categoryNames.business);
              }}
              style={{
                backgroundColor: category == categoryNames.business ? "#181818" : "#fff",
                color: category == categoryNames.business ? "#fff" : "#000",
              }}
              onMouseEnter={() => {
                changeCursor("size_defference");
              }}
